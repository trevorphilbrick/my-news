...
const SignUp = () => {
  ...
  <>
                <Container sx={{ height: '100vh'}}>
                    ...
                    <Typography sx={{color: 'black', mt: 1}} onClick={() => navigate("/login")}>Already have an account? <b style={{color: theme.palette.primary.main, cursor: 'pointer'}} >Login</b>.</Typography>
                    </form>
                </Container>
                </Container>
        </>
